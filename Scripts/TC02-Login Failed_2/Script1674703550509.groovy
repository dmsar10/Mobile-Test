...
Mobile.setText(findTestObject('android.widget.EditText (2)'), 'Lol1234', 0)

Mobile.tap(findTestObject('Object Repository/android.view.ViewGroup (1)'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Password is required'), 'Password is required')
